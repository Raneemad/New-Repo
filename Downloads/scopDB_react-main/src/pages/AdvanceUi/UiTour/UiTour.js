...
import logolight from "../../../assets/images/scop-light.png";
                                                ...
                                                <Col lg={5}>
                                                    <div className="text-center mt-4 mb-5">
                                                        <div className="py-3 px-2 d-inline-block" id="logo-tour">
                                                            <img src={logodark} className="card-logo card-logo-dark" alt="logo" height="30" />
                                                            <img src={logolight} className="card-logo card-logo-light" alt="logo" height="30" />
                                                        </div>
                                                        ...
                                                        <Col lg={4}>
                                                            <Card className="border shadow-none">
                                                                <CardBody className="text-center">
                                                                    ...
                                                                    <p className="text-muted mb-0">Sign in to continue to SCOP Database.</p>
                                                                </CardBody>
                                                            </Card>
                                                        </Col>
