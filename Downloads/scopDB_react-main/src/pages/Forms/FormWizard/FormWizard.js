                          ...
                          <div className="text-center">
                            <div className="mb-4">
                              <lord-icon
                                ...
                                trigger="loop"
                                colors="primary:#0ab39c,secondary:#152C48"
              ...
              <Card>
                ...
                <CardBody>
                  <Form className="form-steps">
                    <div className="text-center pt-3 pb-4 mb-1">
                    <img src={logoDark} className="card-logo mx-auto card-logo-dark" alt="logo dark" height="30" />
                      <img src={logoLight} className="card-logo mx-auto card-logo-light" alt="logo light" height="30" />
                    </div>
