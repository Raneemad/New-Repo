        ...
        <React.Fragment>
            <Row>
                    ...
                    <Card>
                        <CardBody>
                            <div className="text-muted">
                                ...
                                <p>The Saudi Authority for Intellectual Property aims to regulate, support, develop, sponsor, protect, enforce and upgrade the fields of intellectual property in the Kingdom in accordance with international best practices, and it is organizationally linked to the Prime Minister.</p>

                                <ul className="ps-4 vstack gap-2">
                                    <li>Develop the National Strategy for Intellectual Property.</li>
                                    <li>Suggesting rules and regulations related to intellectual property rights.</li>
                ...
                <Col xl={3} lg={4}>
                    <Card>
                        <CardBody>
                            <h5 className="card-title mb-4">Keywords </h5>
