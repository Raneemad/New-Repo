            ...
            <nav className={"navbar navbar-expand-lg navbar-landing fixed-top " + navClass} id="navbar">
                <Container>
                    <Link className="navbar-brand" to="/index">
                        <img src={logodark} className="card-logo card-logo-dark" alt="logo dark" height="30" />
                        <img src={logolight} className="card-logo card-logo-light" alt="logo light" height="30" />
                    </Link>
